...
if (!class_exists('WPBoilerplate_Core_Helper_Functions')) {

    class WPBoilerplate_Core_Helper_Functions
    {
        /**
         * $instance
         * @since 1.0.0
        ...
        public function __construct()
        {
            ...
            add_filter('wp_check_filetype_and_ext', array($this, 'wpboilerplate_disable_real_mime_check'), 10, 4);
        }
        ...
        function post_thumbnail()
        {
            ...
            if (is_singular()) :
?>
                <?php the_post_thumbnail('wpboilerplate_classic'); ?>
            <?php else : ?>
                <a href="<?php the_permalink(); ?>" aria-hidden="true" tabindex="-1">
                    <?php
                    the_post_thumbnail('wpboilerplate_classic', array(
...
<?php
         ...
         */
        /**
         * wpboilerplate_disable_real_mime_check
         * wpboilerplate_disable_real_mime_check()
         * @since 1.0.0
         */
        function wpboilerplate_disable_real_mime_check($data, $file, $filename, $mimes)
        {
        ...
        public function posted_by()
        {
            $byline = sprintf(
                ...
                '<span class="author vcard"><a class="url fn n" href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '"><i class="fas fa-user"></i> ' . esc_html__('By ', 'wpboilerplate') . esc_html(get_the_author()) . '</a></span>'
            );
        ...
        public function posted_tag()
        {
            ...
            if ($tags_list) {
                ...
                printf('<ul class="tags"><li class="title">' . esc_html__('Tags: ', 'wpboilerplate') . '</li><li>' . ' %1$s' . '</li></ul>', $tags_list); // WPCS: XSS OK.
            }
        }
        ...
        public function post_navigation()
        {
            the_post_navigation(array(
                'prev_text' => '<i class="fas fa-angle-double-left"></i>&nbsp;' . esc_html__('Prev Post', 'wpboilerplate'),
                'next_text' => esc_html__('Next Post', 'wpboilerplate') . '&nbsp;<i class="fas fa-angle-double-right"></i>',
            ));
            echo wp_kses('<div class="clearfix"></div>', wpboilerplate()->kses_allowed_html('all'));
        }
        ...
        public function get_contact_form_shortcode_list_el()
        {
            ...
            if ($forms) {
                ...
                $forms_list[esc_html__('No contact form found', 'wpboilerplate-core')] = 0;
            }
            return $forms_list;
        }
        ...
        {
            return defined('WPBOILERPLATE_CORE_SELF_PATH') ? true : false;
        }
        ...
        public function getPostViews($postID)
        {
            ...
            if ($count == '') {
                ...
                printf(' 0 %s', esc_html__('Views', 'wpboilerplate'));
            }
            printf($count . ' %s ', esc_html__('Views', 'wpboilerplate'));
        }
        ...
        public function render_elementor_icons($settings, $attr = [])
        {
            ...
            return \WPBoilerplate\WPBoilerplate_elementor_icon_manager::render_icon($settings, $attr);
        }
    } //end class

    if (class_exists('WPBoilerplate_Core_Helper_Functions')) {
        WPBoilerplate_Core_Helper_Functions::getInstance();
    }
}
