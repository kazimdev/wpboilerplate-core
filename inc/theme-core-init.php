...
if (!class_exists('WPBoilerplate_Core_Init')) {
    ...
    class WPBoilerplate_Core_Init
    {
        ...
        {
            $includes_files = require_once WPBOILERPLATE_CORE_CONFIG . '/files-php.php';
        ...
        public function load_plugin_css_files()
        {
            ...
            $all_css_files = require_once WPBOILERPLATE_CORE_CONFIG . '/files-css.php';
        ...
        public function load_plugin_js_files()
        {
            ...
            $all_js_files = require_once WPBOILERPLATE_CORE_CONFIG . '/files-js.php';
