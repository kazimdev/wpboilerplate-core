...
if (!class_exists('WPBoilerplate_Custom_Post_Type')) {
    class WPBoilerplate_Custom_Post_Type
    {
        ...
        public function register_custom_post_type()
        {
            ...
            $all_post_type = require_once WPBOILERPLATE_CORE_ROOT_PATH . '/config/cpt.php';
            ...
            $all_custom_taxonmy = require_once WPBOILERPLATE_CORE_ROOT_PATH . '/config/custom-taxonomy.php';
