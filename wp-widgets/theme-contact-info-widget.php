...
class WPBoilerplate_Contact_Info_Widget extends WP_Widget
{

	public function __construct()
	{
		parent::__construct(
			'wpboilerplate_contact_info',
			esc_html__('WPBoilerplate: Contact Info', 'wpboilerplate-core'),
			array('description' => esc_html__('Display contact info widget', 'wpboilerplate-core'))
		);
	}
...
?>
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:', 'wpboilerplate-core'); ?></label>
			<input type="text" class="widefat" id="<?php echo esc_attr($this->get_field_id('title')) ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" value="<?php echo esc_attr($title) ?>">
		</p>
		<?php foreach ($contact_info as $ci) : ?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id($ci)); ?>"><?php echo esc_html(ucfirst($ci) . " " . esc_html__('Info', 'wpboilerplate-core')); ?>
					: </label>
				<br />
				...
				<small><?php echo esc_html__('Leave it blank if you don\'t want to show this info', 'wpboilerplate-core') ?></small>
			</p>
...
if (!function_exists('WPBoilerplate_Contact_Info_Widget')) {
	function WPBoilerplate_Contact_Info_Widget()
	{
		register_widget('WPBoilerplate_Contact_Info_Widget');
	}
	add_action('widgets_init', 'WPBoilerplate_Contact_Info_Widget');
}
