...
class WPBoilerplate_Read_More_Widget extends Widget_Base
{
    ...
    {
        return 'wpboilerplate-read-more-widget';
    }
    ...
    {
        return esc_html__('Read More Item', 'wpboilerplate-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new WPBoilerplate_Read_More_Widget());
