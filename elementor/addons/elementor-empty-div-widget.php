...
class Empty_Div_One extends Widget_Base
{
    ...
    {
        return 'wpboilerplate-empty-dib-widget';
    }
    ...
    {
        return esc_html__('Empty Div', 'wpboilerplate-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'shape-radius',
            [
                'label' => esc_html__('Shape Radius', 'wpboilerplate-core'),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'shape_border',
                'label' => esc_html__('Shape Border', 'wpboilerplate-core'),
                'selector' => '{{WRAPPER}} .shape',
            ]
        );
        $this->add_control(
            'shape_height',
            [
                'label' => esc_html__('Shape Height', 'wpboilerplate-core'),
        ...
        $this->add_control(
            'shape_width',
            [
                'label' => esc_html__('Shape Width', 'wpboilerplate-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                'range' => [
                    'px' => [
