...
class WPBoilerplate_Icon_Box_One_Widget extends Widget_Base
{
    ...
    {
        return 'wpboilerplate-icon-box-item-widget';
    }
    ...
    {
        return esc_html__('Icon Box: 01', 'wpboilerplate-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__('User friendly system added', 'wpboilerplate-core'),
            ]
        );
        $this->add_control(
            'link',
        ...
        $this->add_control(
            'icon',
            [
                'label' => esc_html__('Icon', 'wpboilerplate-core'),
                'type' => Controls_Manager::ICONS,
                'description' => esc_html__('select Icon.', 'wpboilerplate-core'),
                'default' => [
        ...
        $this->add_control(
            'text_icon',
            [
                'label' => esc_html__('Text Icon', 'wpboilerplate-core'),
                'type' => Controls_Manager::TEXT,
                'description' => esc_html__('enter text.', 'wpboilerplate-core'),
                'default' => esc_html__('1', 'wpboilerplate-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXTAREA,
                'description' => esc_html__('enter text.', 'wpboilerplate-core'),
                'default' => esc_html__('There is a very fast AVANCE L5 system for internet access and it did not disappoint.', 'wpboilerplate-core')
            ]
        );
        $this->add_control(
            'text_align',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Box Styling Settings', 'wpboilerplate-core'),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'box_shadow',
                'label' => esc_html__('Box Shadow', 'wpboilerplate-core'),
                'selector' => '{{WRAPPER}} .icon-box-item',
            ]
        );
        $this->add_control(
            'title_margin_bottom',
            [
                'label' => esc_html__('Title Margin Bottom', 'wpboilerplate-core'),
        ...
        $this->add_control('number_color', [
            'label' => esc_html__('Number Color', 'wpboilerplate-core'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Style', 'wpboilerplate-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'icon_border_radius',
            [
                'label' => esc_html__('Icon Border Radius', 'wpboilerplate-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
        ...
        $this->add_control(
            'icon_height',
            [
                'label' => esc_html__('Icon Height', 'wpboilerplate-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'icon_width',
            [
                'label' => esc_html__('Icon Width', 'wpboilerplate-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'icon_size',
            [
                'label' => esc_html__('Icon Size', 'wpboilerplate-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'icon_margin_bottom',
            [
                'label' => esc_html__('Icon Margin Bottom', 'wpboilerplate-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'range' => [
                    'px' => [
        ...
        $this->add_control(
            'icon_margin_left',
            [
                'label' => esc_html__('Icon Margin Left', 'wpboilerplate-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_control(
            'position',
            [
                'label' => esc_html__('Position', 'wpboilerplate-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'top',
                'options' => [
                    'top' => esc_html__('Top', 'wpboilerplate-core'),
                    'left' => esc_html__('Left', 'wpboilerplate-core'),
                    'right' => esc_html__('Right', 'wpboilerplate-core'),
                ],
            ]
        );
        $this->add_control(
            'icon_shape_style',
            [
                'label' => esc_html__('Icon Shape Style', 'wpboilerplate-core'),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => esc_html__('Default', 'wpboilerplate-core'),
                    'shape' => esc_html__('Style 01', 'wpboilerplate-core'),
                    'shape_02' => esc_html__('Style 02', 'wpboilerplate-core'),
                    'shape_03' => esc_html__('style 03', 'wpboilerplate-core'),
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Text Icon Typography', 'wpboilerplate-core'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Number Typography', 'wpboilerplate-core'),
...
Plugin::instance()->widgets_manager->register_widget_type(new WPBoilerplate_Icon_Box_One_Widget());
