...
class WPBoilerplate_Accordion_One extends Widget_Base
{
    ...
    {
        return 'wpboilerplate-accordion-one-widget';
    }
    ...
    {
        return ['ir-tech', 'wpboilerplate', 'accordion'];
    }
    ...
    {
        return esc_html__('Accordion 01', 'wpboilerplate-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('accordion_items', [
            ...
            'default'     => [
                [
                    'title'        => esc_html__('How can I get started with WPBoilerplate Advisors? How do I know if I qualify for your services?', 'wpboilerplate-core'),
                    'description' => esc_html__("All investment decisions at WPBoilerplate Advisors are made in-house. As an independent investment advisor, we have the flexibility to select the opportunities from the broader investment universe across public equities, private shares, real estate, and mutual funds. Our investment philosophy emphasizes ethical investing, and that our clients' investments align with their values. We carefully screen for and seek to avoid industries such as alcohol, gambling, pornography, tobacco, and war-making.", 'wpboilerplate-core'),
                ]
            ],
...
Plugin::instance()->widgets_manager->register_widget_type(new WPBoilerplate_Accordion_One());
